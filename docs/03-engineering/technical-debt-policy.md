...
## Purpose
Define technical-debt governance.
## Scope
Architecture and governance specification only; no runtime behavior is implemented by this document.
## Main Content
Record debt, prioritize it by risk and maintenance cost, avoid hiding it in scope, and resolve it through approved work. Debt thresholds and tracking system are Decision Required.
