...
## Purpose
Define dependency maintenance rules.
## Scope
Architecture and governance specification only; no runtime behavior is implemented by this document.
## Main Content
Use approved package managers and pinned compatible dependencies. Review purpose, maintenance, security impact, and compatibility before changes. Major dependency replacement is a Red decision.
