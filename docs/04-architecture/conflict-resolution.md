...
# Conflict Resolution
## Purpose
Define conflict handling requirements.
## Scope
Architecture and governance specification only; no runtime behavior is implemented by this document.
## Main Content
Conflicting evidence must remain visible, traceable, and non-silently averaged. Resolution policy, escalation, and no-decision criteria are Decision Required.
